  ...
  return (
    ...
    >
      <div className="flex items-center gap-2 border-b-[3px] border-presentation-ink bg-presentation-surface px-4 py-3 text-presentation-ink">
        <span className="size-3 rounded-full border-2 border-presentation-ink bg-presentation-accent" aria-hidden="true" />
      ...
      <pre
        className={cn(
          "min-h-0 flex-1 overflow-auto p-4 font-mono text-xs font-bold leading-6 text-presentation-surface md:p-5 md:text-sm md:leading-7",
          codeClassName,
        )}
      >
        <code>{code}</code>
