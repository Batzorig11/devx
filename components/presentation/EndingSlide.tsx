...
export function EndingSlide() {
  return (
    <section
      ...
      className="relative flex min-h-dvh w-full flex-col overflow-x-hidden overflow-y-auto bg-[#efeee8] px-5 pb-28 pt-5 text-black [background-image:radial-gradient(circle,#11111114_1px,transparent_1px)] [background-size:22px_22px] md:h-dvh md:overflow-hidden md:px-10 md:pt-8"
    >
      <header className="relative z-20 mb-5 flex items-center justify-between border-b-[3px] border-black pb-3 font-mono text-xs font-black uppercase tracking-[0.18em] md:text-sm">
      ...
      <div className="grid min-h-0 flex-1 items-center">
        <BrutalCard className="grid min-h-[28rem] overflow-hidden p-0 lg:grid-cols-[1fr_0.36fr]">
          <div className="flex flex-col justify-between p-6 md:p-9">
            <Eyebrow className="bg-[#5b8cff] text-black">
            ...
            <p className="border-l-[7px] border-black pl-4 font-mono text-xs font-black uppercase tracking-[0.12em] md:text-sm">
              Learn · Build · Repeat
            </p>
          </div>

          <div className="flex min-h-64 flex-col items-center justify-between border-t-[3px] border-black bg-[#5b8cff] p-6 text-[#fffdf5] lg:min-h-0 lg:border-l-[3px] lg:border-t-0">
